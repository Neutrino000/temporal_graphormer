...
def compute_similarity_transform(S1, S2): #[14, 3][14, 3]
    ...
    U, s, Vh = np.linalg.svd(K) #[3, 3][3,][3, 3]
    V = Vh.T
    # Construct Z that fixes the orientation of R to get det(R)=1.
    Z = np.eye(U.shape[0]) #[3, 3]
...
def reconstruction_error(S1, S2, reduction='mean'): #[20, 14, 3][20, 14, 3]
